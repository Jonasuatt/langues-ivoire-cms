...
export const GUIDE_MODULES = [
...

  {
    ...
    icon: '🎓',
    title: 'Leçons',
    subtitle: 'Parcours pédagogiques A1-C1 avec images et vidéos',
    color: 'indigo',
    roles: ['EDITOR', 'ADMIN', 'SUPER_ADMIN'],
    description:
      'Le module Leçons permet de créer des parcours pédagogiques complets structurés par langue et niveau (A1 à C1). Chaque leçon est composée d\'étapes interactives enrichies d\'images et de vidéos. Dans les zones à fort taux d\'analphabétisme, l\'image et le son sont les vecteurs principaux d\'apprentissage — chaque mot de vocabulaire devrait idéalement être accompagné d\'une image illustrative.',
    objectifs: [
      'Créer des parcours pédagogiques complets, progressifs et visuellement attractifs',
      'Structurer le contenu par niveau selon le Cadre Européen Commun (A1-C1)',
      'Associer une image à chaque mot de vocabulaire pour favoriser la mémorisation visuelle',
      'Ajouter des vidéos contextuelles par étape pour montrer les situations réelles d\'usage',
      'Définir des exercices interactifs variés avec images pour les apprenants non-lecteurs',
    ],
    features: [
      'Niveaux A1, A2, B1, B2, C1 conformes au CECRL',
      'Types d\'étapes : Vocabulaire, Dialogue, Grammaire, Exercice',
      '🖼 Image par mot de vocabulaire (imageUrl) — affichée en grand sur mobile',
      '🎬 Vidéo illustrative par étape (videoUrl) — contexte culturel / situation réelle',
      '🖼 Image par exercice (imageUrl) — obligatoire pour le type IMAGE_WORD',
      'Indicateurs visuels dans l\'éditeur : compteur images/mots, badge Vidéo',
      'Aperçus miniatures des images directement dans le formulaire',
      'Animations fluides sur mobile : slide entre cartes, bounce correct, confettis ≥80%',
      'Exercice IMAGE_WORD : l\'apprenant associe une image au mot sans lire',
    ...
    steps: [
      ...
      { title: 'Ajouter une étape Vocabulaire', desc: 'Choisir le type "Vocabulaire". Pour chaque mot : saisir le mot, la traduction et la phonétique. Audio : cliquer "Importer un audio" et sélectionner un fichier MP3/WAV depuis le PC → upload automatique vers Cloudinary. Image : cliquer "Importer une image" et sélectionner JPG/PNG → aperçu instantané. Glisser-déposer aussi accepté.', warning: null },
      { title: 'Ajouter une vidéo de contexte', desc: 'Dans le bloc violet "Vidéo illustrative", cliquer "Importer une vidéo" et sélectionner un fichier MP4/MOV depuis le PC (max 100 Mo). La vidéo est hébergée automatiquement sur Cloudinary avec compression. Vous pouvez aussi coller une URL directe dans le champ texte en bas.', warning: null },
      { title: 'Créer un exercice IMAGE_WORD', desc: 'Dans une étape, cliquer "+ Ajouter un exercice" et choisir "Image & Mot". Cliquer "Importer une image" ou coller une URL. Rédiger la question ("Que voit-on ?") et ajouter 4 choix dont le correct. L\'apprenant voit l\'image et choisit le bon mot — aucune lecture requise.', warning: null },
      { title: 'Vérifier les indicateurs visuels', desc: 'Dans la liste des étapes, vérifier le badge "X/Y images" : il doit afficher le même nombre de mots et d\'images (ex: "5/5 images" en vert). Le badge "Vidéo" confirme la présence d\'une vidéo contextuelle.', warning: 'Un badge orange "3/5 images" signifie que 2 mots n\'ont pas d\'image : compléter avant de publier.' },
      { title: 'Publier', desc: 'Cliquer sur "Publier". La leçon avec images et vidéos sera visible sur mobile avec animations : chaque carte arrive en glissant, les bonnes réponses rebondissent, et un feu d\'artifice s\'affiche en fin de leçon si le score est ≥80%.', warning: null },
    ],
    workflows: [
      {
        title: 'Création d\'une leçon visuelle A1 "Les salutations en Baoulé"',
        steps: [
          'Créer la leçon : titre "Les salutations", langue Baoulé, niveau A1, durée 12 min',
          'Étape 1 Vocabulaire : sélectionner 6 mots. Pour chaque mot, coller l\'URL d\'une image illustrative (ex: photo d\'une personne qui salue)',
          'Ajouter une vidéo de 10s montrant deux personnes qui se saluent au marché',
          'Étape 2 Dialogue : créer un échange de 4 répliques entre Kouadio et Zélé + vidéo de la scène',
          'Étape 3 Grammaire : documenter la règle de politesse + image d\'un schéma',
          'Étape 4 Exercice IMAGE_WORD : 3 questions avec photo → apprenant choisit le mot sans lire',
          'Étape 5 Exercice QCM : 3 questions textuelles de consolidation',
          'Vérifier les indicateurs : "6/6 images" en vert, badge "Vidéo" sur étapes 1 et 2',
          'Publier la leçon',
        ],
      },
      {
        title: 'Importer les images et vidéos depuis le PC',
        steps: [
          'Dans le formulaire d\'étape, cliquer sur "Importer une image" (zone grise avec icône 🖼)',
          'La boîte de dialogue de votre ordinateur s\'ouvre — sélectionner le fichier JPG, PNG ou WEBP',
          'L\'upload commence automatiquement avec une barre de progression. Le fichier est envoyé sur Cloudinary',
          'Une fois terminé, l\'aperçu s\'affiche et le message "Fichier uploadé et hébergé sur Cloudinary ✓" confirme le succès',
          'Pour les vidéos : même processus avec "Importer une vidéo" → MP4, MOV, WEBM → max 100 Mo',
          'Vous pouvez aussi glisser-déposer un fichier directement sur la zone pointillée',
          'Si vous préférez un lien existant (YouTube, CDN externe) : coller l\'URL dans le champ texte en bas de la zone',
          'Formats recommandés — Image : JPEG/WebP, 800×600 px minimum, < 300 Ko. Vidéo : MP4 H.264, < 50 Mo',
          'Ne pas utiliser Google Drive, Dropbox ou OneDrive — les URLs de partage ne sont pas stables',
        ],
      },
    ],
    tip: 'Objectif visuel : 100% des mots de vocabulaire avec image + 1 vidéo de contexte par étape. Dans les zones rurales de Côte d\'Ivoire, l\'image remplace le texte pour les apprenants non-lecteurs. Une leçon avec images est 3× plus engageante qu\'une leçon texte-seul.',
    warnings: [
      'Les URLs d\'images doivent être publiquement accessibles depuis mobile — tester depuis un réseau 3G',
      'Les vidéos > 10 Mo ralentissent le chargement : privilégier les vidéos compressées < 5 Mo',
    ],
    audioNaming: null,
  },
