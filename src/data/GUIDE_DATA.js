...
export const GUIDE_MODULES = [
...

  {
    ...
    steps: [
      ...
      { title: 'Ajouter une étape Vocabulaire', desc: 'Choisir le type "Vocabulaire". Remplir le titre, puis pour chaque mot : mot en langue, traduction, phonétique, URL audio. Coller l\'URL de l\'image du mot dans le champ "URL Image du mot" — un aperçu s\'affiche immédiatement.', warning: null },
      { title: 'Ajouter une vidéo de contexte', desc: 'Dans le bloc violet "Vidéo illustrative de l\'étape", coller l\'URL .mp4 ou l\'embed YouTube de la vidéo. Elle s\'affiche directement dans l\'étape sur mobile avant les mots. Idéal : 5-15 secondes montrant la situation (marché, école, famille).', warning: null },
      { title: 'Créer un exercice IMAGE_WORD', desc: 'Dans une étape, cliquer "+ Ajouter un exercice" et choisir le type "Image & Mot". Coller l\'URL de l\'image, rédiger la question ("Que voit-on ?"), ajouter 4 choix dont le correct. L\'apprenant voit l\'image et choisit le bon mot — aucune lecture requise.', warning: null },
    ...
    workflows: [
      ...
      {
        title: 'Importer les images et vidéos',
        steps: [
          'Images : héberger sur un CDN (Cloudinary, AWS S3, Firebase Storage) ou utiliser des URLs publiques stables',
          'Format image recommandé : JPEG ou WebP, 800×600 px minimum, < 200 Ko pour performance mobile',
          'Vidéos : héberger sur YouTube (non listé), Vimeo ou un bucket S3. Copier l\'URL directe .mp4 ou l\'embed URL',
          'NE PAS utiliser Google Drive ou Dropbox — les URLs ne sont pas pérennes',
          'Tester l\'URL avant de l\'enregistrer : coller dans un navigateur et vérifier que l\'image/vidéo s\'affiche',
          'Nommer les fichiers clairement : "baoulé_salutation_bonjour.jpg", "dioula_marché_dialogue.mp4"',
        ],
      },
    ],
