...
export const GUIDE_MODULES = [
  ...
  // ─────────────────────────────────────────────
  {
    ...
    roles: ['EDITOR', 'ADMIN', 'SUPER_ADMIN'],
    description:
      'Ce module gère les phrases vitales pour les situations d\'urgence médicale ainsi que les localisations corporelles douloureuses ("Où j\'ai mal ?"). Ces phrases sont disponibles dans les 9 langues ivoiriennes MVP et chacune doit impérativement disposer des 4 enregistrements audio M/F.',
    objectifs: [
      'Couvrir toutes les situations d\'urgence médicale courantes',
      'Fournir les 4 audios M/F complets pour chaque phrase d\'urgence',
    ...
    features: [
      ...
      '4 champs audio distincts : 👨 local, 👩 local, 👨 français, 👩 français',
      'Sélecteur de genre du locuteur (M/F)',
    ...
    steps: [
      ...
      { title: 'Uploader les 4 audios M/F', desc: 'Importer les 4 enregistrements obligatoires : locuteur local masculin, locutrice locale féminine, locuteur français masculin, locutrice française féminine.', warning: 'Ces phrases sont utilisées dans des situations médicales critiques. Vérifier impérativement la traduction et la prononciation avec un locuteur natif AVANT publication.' },
    ...
    workflows: [
      {
        ...
        steps: [
          ...
          'Enregistrer les 4 audios par phrase (2 locuteurs natifs + 2 voix françaises)',
...

  {
    ...
    roles: ['EDITOR', 'ADMIN', 'SUPER_ADMIN'],
    description:
      'Phrasebook multilingue couvrant les expressions de la vie quotidienne : salutations, expressions courantes, nourriture, lieux, vie sociale et plus. Chaque phrase dispose de 4 audios M/F et d\'informations de contexte d\'usage pour aider les apprenants à employer les expressions de manière appropriée.',
    objectifs: [
    ...
    features: [
      ...
      '4 audios M/F par phrase (locuteur local masculin, féminin, français masculin, féminin)',
      'Sélecteur de genre du locuteur',
    ...
    steps: [
      ...
      { title: 'Uploader les 4 audios M/F', desc: 'Importer les enregistrements dans l\'ordre : locuteur local masculin, locutrice locale féminine, locuteur français masculin, locutrice française féminine.', warning: null },
    ...
    workflows: [
      {
        ...
        steps: [
          ...
          'Enregistrer les 4 audios par salutation par langue',
...

  {
    ...
    steps: [
      ...
      { title: 'Démarrer l\'import', desc: 'Cliquer sur "+ Ajouter" et sélectionner un ou plusieurs fichiers audio depuis votre ordinateur.', warning: null },
...

  {
    ...
    roles: ['ADMIN', 'SUPER_ADMIN'],
    description:
      'Interface de gestion du module d\'intelligence artificielle linguistique pour accélérer la création de contenus et l\'analyse phonétique. L\'IA peut suggérer des mots manquants dans le corpus, générer des phonétiques, proposer des traductions et analyser la distribution du contenu par langue.',
    objectifs: [
    ...
    features: [
      ...
      'Import audio en masse avec transcription automatique',
    ],
    steps: [
      ...
      { title: 'Valider les suggestions', desc: 'L\'IA génère des suggestions — toujours les valider avec un tuteur natif avant d\'intégrer le contenu dans les modules officiels.', warning: null },
    ],
    workflows: [],
