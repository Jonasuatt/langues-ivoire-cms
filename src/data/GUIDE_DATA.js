...
export const GUIDE_MODULES = [
...

  {
    ...
    roles: ['ADMIN', 'SUPER_ADMIN'],
    description:
      'Le module Notifications permet d\'envoyer des notifications push vers l\'application mobile pour informer, rappeler ou annoncer du contenu aux utilisateurs. En plus des notifications manuelles, certaines notifications sont envoyées automatiquement par le système — notamment lors de la validation du numéro de téléphone d\'un utilisateur. Les notifications manuelles peuvent être ciblées (tous les utilisateurs, une langue spécifique, un utilisateur précis) et programmées à l\'avance.',
    objectifs: [
      ...
      'Comprendre les notifications automatiques envoyées par le système',
    ],
    features: [
      'Types de notifications manuelles : Système, Badge, Rappel, Annonce, Publicité',
      'Type automatique PHONE_VALIDATED : envoyée automatiquement lors de la validation du téléphone d\'un utilisateur (module Utilisateurs)',
    ...
    steps: [
      { title: 'Créer une notification manuelle', desc: 'Cliquer sur "+ Nouvelle notification", choisir le type et rédiger le titre et le message.', warning: null },
      ...
      { title: 'Notifications automatiques (PHONE_VALIDATED)', desc: 'Ces notifications sont déclenchées automatiquement par le système — elles n\'ont pas à être créées manuellement. Exemple : quand un admin valide un numéro de téléphone dans le module Utilisateurs, la notification "📱 Numéro de téléphone activé" est envoyée en temps réel à cet utilisateur. Elles apparaissent dans l\'historique.', warning: null },
    ],
    workflows: [
      {
        title: 'Notification automatique PHONE_VALIDATED (pour information)',
        steps: [
          'Un utilisateur demande l\'activation de son téléphone via WhatsApp',
          'L\'admin valide le numéro dans le module Utilisateurs (bouton « Valider »)',
          'Le système envoie automatiquement une notification in-app de type PHONE_VALIDATED',
          'L\'utilisateur reçoit : "📱 Numéro de téléphone activé — Vous pouvez maintenant vous connecter avec votre numéro de téléphone."',
          'La notification apparaît dans l\'historique du module Notifications',
          'Aucune action requise de la part de l\'admin — tout est automatique',
        ],
      },
    ],
    tip: 'Programmez les rappels d\'apprentissage le soir (18h-20h) quand les utilisateurs sont disponibles. Les notifications automatiques (PHONE_VALIDATED) n\'ont pas besoin d\'être gérées manuellement — elles s\'enclenchent depuis le module Utilisateurs.',
    warnings: [
      'Les notifications push manuelles sont limitées en fréquence acceptable. Ne dépassez pas 2-3 notifications par semaine pour éviter la fatigue des utilisateurs et les désabonnements.',
      'Ne pas recréer manuellement les notifications automatiques (PHONE_VALIDATED) — elles sont déjà envoyées par le système lors de la validation du téléphone.',
    ],
    audioNaming: null,
  },
  ...
  // ─────────────────────────────────────────────
  {
    ...
    icon: '👥',
    title: 'Utilisateurs',
    subtitle: 'Utilisateurs mobiles & accès CMS',
    color: 'gray',
    roles: ['ADMIN', 'SUPER_ADMIN'],
    description:
      'Ce module centralise la gestion de tous les comptes de la plateforme : utilisateurs de l\'application mobile ET membres de l\'équipe CMS. Il permet de consulter les profils, modifier les rôles, gérer les accès et — fonctionnalité clé — valider les numéros de téléphone des utilisateurs mobiles pour leur permettre de se connecter sans mot de passe.',
    objectifs: [
    ...
    features: [
      'Liste de tous les utilisateurs (mobile + CMS) avec rôle, statut et dernière activité',
    ...
    steps: [
      ...
      {
        title: 'Créer un nouveau compte CMS',
        desc: 'Cliquer sur "+ Nouveau compte", saisir le nom complet, l\'adresse email et définir le rôle approprié.',
        warning: null,
      },
      {
      ...
      {
        title: 'Envoyer les accès CMS',
        desc: 'Le nouveau membre reçoit ses identifiants de connexion. Planifier une session de formation en lui partageant le Guide d\'utilisation CMS.',
        warning: null,
      },
    ],
    workflows: [
