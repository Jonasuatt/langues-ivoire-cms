...
const EMPTY_URGENCE = { languageId: '', phrase: '', transcription: '', traduction: '', contexte: '🆘', audioUrl: '', audioUrlFr: '', genreLocuteur: '', status: 'PUBLISHED' };
const EMPTY_CORPS   = { languageId: '', bodyPartId: 'tete', phrase: '', transcription: '', audioUrl: '', audioUrlFr: '', genreLocuteur: '', status: 'PUBLISHED' };
...
export default function PhrasesSOSPage() {
  ...
  const openEditCorps = (p) => {
    ...
    setCorpsForm({ languageId: p.languageId || '', bodyPartId: p.contexte || 'tete',
      ...
      audioUrl: p.audioUrl || '', audioUrlFr: p.audioUrlFr || '',
      genreLocuteur: p.genreLocuteur || '', status: p.status || 'PUBLISHED' });
    setSelectedBP(bp);
          ...
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-lg p-6 max-h-[90vh] overflow-y-auto">
            ...
            <div className="space-y-4">
              ...
              <FileUploadField
                ...
                onChange={url => setUrgenceForm(f => ({ ...f, audioUrl: url }))}
              />
              <FileUploadField
                type="audio"
                label="🇫🇷 Audio français (narration)"
                value={urgenceForm.audioUrlFr}
                onChange={url => setUrgenceForm(f => ({ ...f, audioUrlFr: url }))}
              />
          ...
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-lg p-6 max-h-[90vh] overflow-y-auto">
            ...
            <div className="space-y-4">
              ...
              <FileUploadField
                ...
                onChange={url => setCorpsForm(f => ({ ...f, audioUrl: url }))}
              />
              <FileUploadField
                type="audio"
                label="🇫🇷 Audio français (narration)"
                value={corpsForm.audioUrlFr}
                onChange={url => setCorpsForm(f => ({ ...f, audioUrlFr: url }))}
              />
