    ...
    modules: [
      ...
      },
      {
        ...
        steps: [
          ...
          { title: 'Ajouter des images', desc: 'Ouvrez la galerie. Cliquez sur « + Ajouter des images ». Uploadez les fichiers PNG/JPG. Saisissez le mot en langue locale, sa phonétique et sa traduction pour chaque image.' },
          { title: 'Supprimer une image', desc: 'Survolez l\'image. Cliquez sur l\'icône corbeille qui apparaît. Confirmez la suppression.' },
        ],
        tip: 'Utilisez des images claires sur fond blanc ou neutre pour faciliter la reconnaissance visuelle.',
      },
      {
        id: 'videos',
        route: '/videos',
        ...
        features: [
          ...
          'Titre, description, langue, durée, miniature automatique.',
    ...
    modules: [
      {
        ...
        steps: [
          { title: 'Modérer une contribution', desc: 'Cliquez sur une contribution pour l\'ouvrir. Vérifiez le mot, la traduction et l\'audio. Cliquez sur « Approuver » ou « Rejeter ». Un motif de rejet peut être envoyé à l\'utilisateur.' },
        ...
        tip: 'Traitez les contributions dans les 48 h. Un délai trop long décourage les contributeurs.',
      },
      {
        id: 'messages',
        route: '/messages',
        ...
        features: [
          ...
          'Réponse directe depuis le CMS (e-mail envoyé à l\'utilisateur).',
          'Clôture manuelle du ticket.',
        ],
        steps: [
          { title: 'Répondre à un message', desc: 'Cliquez sur un ticket ouvert. Lisez le message de l\'utilisateur. Rédigez votre réponse dans la zone de texte. Cliquez sur « Envoyer ». Le ticket passe automatiquement en statut « En cours ».' },
          { title: 'Clôturer un ticket', desc: 'Une fois le problème résolu, cliquez sur « Marquer comme résolu ».' },
        ],
        tip: 'Répondez dans les 48 heures ouvrables pour maintenir la satisfaction des utilisateurs.',
      },
      {
        id: 'certificates',
        route: '/certificates',
        ...
        iconBg: 'bg-yellow-50',
        description: 'Génération et gestion des certificats de complétion remis aux apprenants.',
        features: [
        ...
        tip: 'Les certificats sont automatiquement générés quand un utilisateur complète toutes les leçons d\'un niveau. L\'émission manuelle est utile pour les cas particuliers.',
      },
      {
        id: 'ia-linguistique',
