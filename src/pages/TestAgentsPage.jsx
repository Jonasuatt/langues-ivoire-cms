...
function MessageBubble({ msg, agent, onPlayAudio, onSpeak }) {
      ...
      <div className={`max-w-[75%] ${isUser ? 'items-end' : 'items-start'} flex flex-col gap-1`}>
        ...
        {!isUser && msg.source && (
          <div className="flex items-center gap-2 px-1 flex-wrap">
            ...
            {msg.mot && <span className="text-xs text-gray-400">· {msg.mot}</span>}
          </div>
        )}
      </div>
    </div>
      ...
      <div className="flex flex-1 overflow-hidden">
        <div className="w-72 flex-shrink-0 border-r border-gray-200 bg-gray-50 flex flex-col overflow-y-auto">
          <div className="p-4 space-y-5">
            ...
            {totalMessages > 0 && (
              <div>
                <label className="block text-xs font-semibold text-gray-500 uppercase tracking-wide mb-2">Statistiques session</label>
                  ...
                  {[
                    ...
                    <div key={key} className="flex items-center justify-between text-sm">
                      ...
                      <div className="flex items-center gap-1">
                        ...
                        <span className="text-gray-400 text-xs">({Math.round(stats[key] / totalMessages * 100)}%)</span>
                      </div>
                    </div>
                  ))}
            ...
            <div>
              <label className="block text-xs font-semibold text-gray-500 uppercase tracking-wide mb-2">Questions suggérées</label>
              <div className="space-y-1.5">
                {[
            ...
            {chatHistory.length === 0 ? (
              <div className="flex flex-col items-center justify-center h-full text-center opacity-60">
                <img src={selectedAgent.image} alt={selectedAgent.name}
                  ...
                  style={{ borderColor: selectedAgent.color }} />
                <p className="font-semibold text-gray-700 text-lg">Bonjour ! Je suis {selectedAgent.name}</p>
